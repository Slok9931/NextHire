    ...
    const fetchData = async () => {
        try {
            ...
            setFormData({
                ...
                work_location: jobToEdit.work_location || 'onsite',
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <Card className="shadow-xl border-[#b0b0ff] dark:border-[#0000c5] bg-white/90 dark:bg-gray-900/90 backdrop-blur-md">
                    <CardHeader>
                        ...
                        <CardDescription>
                            {currentStep === 1 && "Update the basic information about this job position"}
                            {currentStep === 2 && "Modify the specific details about compensation and work arrangements"}
                            {currentStep === 3 && "Edit the key responsibilities for this role"}
                            {currentStep === 4 && "Update the qualifications and skills required"}
                            {currentStep === 5 && "Review all changes before updating your job"}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {renderStep()}
