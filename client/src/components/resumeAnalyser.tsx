...
50 dark:bg-red-950/30 mb-4"
                ...
                >
                    <FileCheck size={16} className="text-[#e7234a]" />
                            ...
                            <>
                                <DialogHeader>
                                    <DialogTitle className="text-2xl flex items-center gap-2">
                                        <FileText className="text-[#e7234a]" />
                                        Upload Your Resume
                                    </DialogTitle>
                                    <DialogDescription>
...
flex items-center justify-center"
                                            >
                                                <Upload size={32} className="text-[#494bd6]" />
                                            </div>
                                            <div>
                            ...
                            <>
                                <DialogHeader>
                                    <DialogTitle className="text-2xl flex items-center gap-2">
                                        <FileCheck className="text-[#e7234a]" />
                                ...
                                <div className="space-y-6 py-4">
                                    ...
                                    <div
                                        className="p-4 rounded-lg bg-[#f8fafc] dark:bg-[#1e293b] border
border-[#b0b0ff] dark:border-[#0000c5]"
                                    >
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold mb-3 flex items-center gap-2">
                                            <TrendingUp size={20} className="text-[#e7234a]" />
...
border-green-200 dark:border-green-800"
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold mb-3 flex items-center gap-2">
                                            <AlertTriangle size={20} className="text-[#e7234a]" />
